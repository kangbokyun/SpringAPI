...
function OverFooter(no) {
    if(no == 1) {
        ...
        $("#divOver").html("<div style = 'border : solid 1px black; text-align : center;' id = 'divOver'><h4>운영정책</h4><p>로컬 서버를 이용하거나 AWS를 이용해 배포합니다.<p>문제가 되는 부분이 있다면 아래 메일로 연락 바랍니다.<p>bk940204@naver.com</div>");
    }
}
