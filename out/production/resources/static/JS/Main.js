...
function OverFooter(no) {
    if(no == 1) {
        $("#divOver").html("<div style = 'border : solid 1px black; text-align : center;' id = 'divOver'><h4>개인정보 처리방침</h4><p style = 'margin-bottom : 5px;'>회원가입 시 등록한 개인정보는 어떠한 곳에도 이용하지 않습니다.<p style = 'margin-bottom : 5px; margin-top : 5px;'>될 수 있으면 매일 저녁 22시 언저리에 회원 DB내용 삭제합니다.</div>");
    } else if(no == 2) {
